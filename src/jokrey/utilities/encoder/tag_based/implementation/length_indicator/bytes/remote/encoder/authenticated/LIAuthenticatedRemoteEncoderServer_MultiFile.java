package jokrey.utilities.encoder.tag_based.implementation.length_indicator.bytes.remote.encoder.authenticated;
...
import jokrey.utilities.encoder.tag_based.implementation.length_indicator.bytes.tuple.TupleTagMultiFilesLIEncodersBytesSynchronized;
...
public class LIAuthenticatedRemoteEncoderServer_MultiFile extends AuthenticatedRemoteEncoderServer {
     ...
     */
    public LIAuthenticatedRemoteEncoderServer_MultiFile(File storage_dir) throws IOException {
